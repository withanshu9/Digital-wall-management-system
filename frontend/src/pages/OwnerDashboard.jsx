                        ...
                        {(walls || []).map(wall => (
                            <div key={wall._id} className="p-5 border-b border-gray-800 hover:bg-white/5 transition-colors flex gap-4 items-center">
                                ...
                                <div className="flex flex-col gap-2">
                                    <button className="text-xs font-bold text-gray-300 hover:text-white bg-gray-800 hover:bg-gray-700 px-3 py-1.5 rounded transition-colors text-center" onClick={() => handleEditClick(wall)}>Edit</button>
                                    <button className="text-xs font-bold text-danger hover:text-white bg-danger/10 hover:bg-danger px-3 py-1.5 rounded transition-colors text-center" onClick={() => handleRemoveWall(wall._id)}>Delete</button>
                                </div>
                            </div>
                        ))}
